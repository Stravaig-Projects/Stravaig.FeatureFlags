...
public class SourceWriter
{
    ...
    private SyntaxKind? GetNamespaceKind(CancellationToken ct = default) =>
    ...
    public void GenerateCode(SourceProductionContext productionContext)
    {
        ...
        AddNamespaceStart(fileContent, namespaceName);
    ...
    private void AddNamespaceStart(StringBuilder fileContent, string? namespaceName)
    {
...
public class FeatureFlagSourceGenerator : IIncrementalGenerator
{
    ...
    private static SourceWriter CreateSourceWriter(GeneratorSyntaxContext ctx, CancellationToken _)
        => new SourceWriter((EnumDeclarationSyntax)ctx.Node, ctx.SemanticModel);
